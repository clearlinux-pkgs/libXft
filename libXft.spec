...
Source0  : https://www.x.org/releases/individual/lib/libXft-2.3.5.tar.gz
Source1  : https://www.x.org/releases/individual/lib/libXft-2.3.5.tar.gz.sig
...
%prep
%setup -q -n libXft-2.3.5
cd %{_builddir}/libXft-2.3.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662485537
